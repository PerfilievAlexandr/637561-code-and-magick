...
var renderCloud = function(ctx, CLOUD_X, CLOUD_Y, color){
	...
	ctx.lineTo(CLOUD_X + CLOUD_WIDTH - radiusBegin - radiusMaxCircle, CLOUD_Y);
	ctx.bezierCurveTo(CLOUD_X + CLOUD_WIDTH - radiusBegin, CLOUD_Y, CLOUD_X + CLOUD_WIDTH - radiusMaxCircle, CLOUD_Y + radiusMaxCircle, CLOUD_X + CLOUD_WIDTH, CLOUD_Y + radiusBegin);
	ctx.lineTo(CLOUD_X + CLOUD_WIDTH, CLOUD_Y + CLOUD_HEIGHT - radiusBegin - radiusMaxCircle);
	ctx.bezierCurveTo(CLOUD_X + CLOUD_WIDTH, CLOUD_Y + CLOUD_HEIGHT - radiusBegin, CLOUD_X + CLOUD_WIDTH - radiusMaxCircle, CLOUD_Y + CLOUD_HEIGHT - radiusMaxCircle, CLOUD_X + CLOUD_WIDTH - radiusBegin, CLOUD_Y + CLOUD_HEIGHT);
